...
process.env.GITHUB_RUN_ID = '110200164'
process.env.GITHUB_RUN_NUMBER = '134'
...
process.env.GITHUB_SHA = 'd0d4530a505a87990b764d11f207ea0e8c6e93f7'
process.env.GITHUB_REF = 'refs/heads/fix-undefined-url'
